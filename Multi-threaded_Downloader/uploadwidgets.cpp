#include "uploadwidgets.h"

#include <QHBoxLayout>
#include <QVBoxLayout>

UploadWidgets::UploadWidgets(QWidget *parent) :
    QWidget(parent)
{
...
QString UploadWidgets::friendlyDisplay(double size)
{
...
//进度条动态改变
void UploadWidgets::updateReady(qint64 startPoint, qint64 endPoint, qint64 readySize)
{
 ...
 //根据readySize2和readySize改变speedLabel上的速度信息
void UploadWidgets::updateSpeed()
{
